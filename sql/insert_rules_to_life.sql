insert into life (line_id, rule_id, timer, date) select w.line_id, w.rule_id,w.time, current_date from week_schedule as w where w.day_number = date_part('dow', now());
